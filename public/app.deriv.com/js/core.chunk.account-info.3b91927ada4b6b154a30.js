    ...
    [4773], {
        527671: (e, i, c) => {
            ...
            const y = e => {
                    ...
                    return "MF" === c.replace(/\d/g, "") ? (0, b.jsx)(_.Localize, {
                        i18n_default_text: "Multipliers"
                    }) : s ? (0, b.jsx)(_.Localize, {
                        i18n_default_text: "Demo"
                    }) : i ? (0, d.getCurrencyName)(i) : (0, b.jsx)(_.Localize, {
                ...
                w = e => {
                    ...
                    const m = (0, d.getCFDAccountDisplay)({
                        ...
                        y = s.useCallback((e => {
                            if (e) {
                                var i;
                                const a = null === (i = e.server_info) || void 0 === i || null === (i = i.geolocation) || void 0 === i ? void 0 : i.region;
                                var c, s;
                                if (a) return `${a} ${1===(null==e||null===(c=e.server_info)||void 0===c||null===(c=c.geolocation)||void 0===c?void 0:c.sequence)?"":null==e||null===(s=e.server_info)||void 0===s||null===(s=s.geolocation)||void 0===s?void 0:s.sequence}`
                            }
                            return ""
                        }), []);
                    if (a) return (0, b.jsxs)("div", {
                        ...
                        }), (null == u || null === (i = u.server_info) || void 0 === i ? void 0 : i.geolocation) && x && "synthetic" === t && "svg" === v && (0, b.jsx)(o.Text, {
                    ...
                    const w = (0, d.isBot)();
                    return (0, b.jsxs)("div", {
                        children: ["dxtrade" === r && m === (0, _.localize)("Derived") ? (0, _.localize)("Synthetic") : m, (null == u || null === (c = u.server_info) || void 0 === c ? void 0 : c.geolocation) && x && "synthetic" === t && "svg" === v && (0, b.jsx)(o.Text, {
            ...
            const N = f,
                ...
                C = e => [...e].sort(((e, i) => {
                    const c = z(e),
                        s = z(i);
                    return c && !s ? 1 : s && !c || "gaming" === e.market_type || "synthetic" === e.market_type ? -1 : "financial" === e.sub_account_type ? "gaming" === i.market_type || "synthetic" === i.market_type ? 1 : -1 : 1
                })),
                ...
                D = (0, g.observer)((e => {
                    ...
                    const {
                        ...
                        show_eu_related_content: K,
                        content_flag: Y,
                        selectRegion: J,
                        setTogglePlatformType: Q
                    } = g, {
                        is_dark_mode_on: X,
                    ...
                    } = h, [ae, te] = s.useState(!L || ce ? 0 : 1), [ne, le] = s.useState(!0), [re, oe] = s.useState(!0), [_e, de] = s.useState(!0), [ue, he] = s.useState(!0), ge = s.useRef(), pe = s.useRef(null), ve = B.currency, xe = null === (i = A.find((e => e.is_virtual))) || void 0 === i ? void 0 : i.loginid, me = f[xe] ? f[xe].currency : "USD", be = e => {
                        switch (e) {
                            case "demo_deriv":
                                return le(!ne);
                            case "real_deriv":
                    ...
                    const ze = e => (null == e ? void 0 : e.is_virtual) && 1e4 !== (null == e ? void 0 : e.balance),
                        De = () => {
                            const e = [];
                            return (() => {
                                if (S) return Y === d.ContentFlag.LOW_RISK_CR_NON_EU ? C($).filter((e => !z(e) && "maltainvest" !== e.landing_company_short)) : C($).filter((e => !z(e)));
                                return []
                            })().map((i => {
                                "svg" === i.landing_company_short && "synthetic" === i.market_type && (e.length ? e.forEach((c => (c.server !== i.server && e.push(i), e))) : e.push(i))
                            })), e.length > 1
                        },
                        ...
                        }))) || void 0 === c ? void 0 : c.loginid,
                        Ie = (0, b.jsx)("div", {
                            className: "acc-switcher__list-wrapper",
                            children: xe && (0, b.jsx)(N, {
                                ...
                                children: (0, b.jsx)("div", {
                                    ...
                                    children: k(A, f).filter((e => e.is_virtual)).map((e => (0, b.jsx)(j, {
                                        is_dark_mode_on: X,
                        ...
                        Se = (0, b.jsx)("div", {
                            ...
                            children: (0, b.jsxs)(s.Fragment, {
                                children: [!I || M ? (0, b.jsxs)(N, {
                                    className: "acc-switcher__title",
                                    header: M && H ? (0, _.localize)("Non-EU Deriv " + (Ae("CR") ? "accounts" : "account")) : (0, _.localize)("Deriv " + (Ae("CR") ? "accounts" : "account")),
                                    is_visible: _e,
                                    toggleVisibility: () => {
                                        be("real_deriv")
                                    },
                                    children: [(0, b.jsx)("div", {
                                        className: "acc-switcher__accounts",
                                        children: k(A, f).filter((e => !e.is_virtual && e.loginid.startsWith("CR"))).map((e => (0, b.jsx)(j, {
                                            account_type: D,
                                            is_dark_mode_on: X,
                                            balance: f[e.loginid].balance,
                                            currency: f[e.loginid].currency,
                                    ...
                                    }), !Te && ke().filter((e => "svg" === e)).map(((e, i) => (0, b.jsxs)("div", {
                                ...
                                }) : null, !R && H || I ? (0, b.jsxs)(N, {
                                    header: M && H ? (0, _.localize)("EU Deriv " + (Ae("MF") ? "accounts" : "account")) : (0, _.localize)("Deriv " + (Ae("MF") ? "accounts" : "account")),
                                    is_visible: ue,
                                    toggleVisibility: () => {
                                        be("real_deriv")
                                    },
                                    children: [(0, b.jsx)("div", {
                                        className: "acc-switcher__accounts",
                                        children: k(A, f).filter((e => !e.is_virtual && e.loginid.startsWith("MF"))).map((e => (0, b.jsx)(j, {
                                            account_type: D,
                                            is_dark_mode_on: X,
                                            balance: f[e.loginid].balance,
                                            currency: f[e.loginid].currency,
                                    ...
                                    }), ke().filter((e => "maltainvest" === e)).map(((e, i) => (0, b.jsxs)("div", {
                                        className: "acc-switcher__new-account",
                                        children: [(0, b.jsx)(o.Icon, {
                                            icon: "IcDeriv",
                                            size: 24
                        ...
                        Me = null == A || null === (a = A.find((e => /^(CR|MF)/.test(e.loginid)))) || void 0 === a ? void 0 : a.loginid,
                        Re = () => {
                            const e = () => (0, b.jsx)(s.Fragment, {
                                children: (0, b.jsx)("div", {
                                    className: "acc-switcher__traders-hub",
                                    children: (0, b.jsx)(m.Sm, {
                                        onClick: async () => {
                                            !L && Ne ? await U(G) : L && fe && await U(Me), ee(!1), localStorage.setItem("redirect_to_th_os", "home"), t.push(d.routes.traders_hub), Q("cfd")
                                        },
                    ...
                    return (0, b.jsx)("div", {
                        ...
                        children: S ? (0, b.jsxs)(s.Fragment, {
                            children: [(0, b.jsxs)(o.Tabs, {
                                active_index: ae,
                                ...
                                children: [(0, b.jsxs)("div", {
                                    ...
                                    id: "real_account_tab",
                                    children: [(0, b.jsx)(o.DesktopWrapper, {
                                ...
                                children: [(0, b.jsx)(o.Text, {
                                    ...
                                    children: (0, b.jsx)(o.Money, {
                                        currency: fe ? ve : me,
                                        amount: (0, d.formatMoney)(fe ? ve : me, fe ? B.amount_real : f[xe] ? f[xe].balance : 0, !0),
                                        show_currency: !0,
                                        should_format: !1
                                    })
                                })]
                            ...
                            }), (0, b.jsx)(Re, {}), fe && E && !L && (0, b.jsxs)(b.Fragment, {
                                children: [(0, b.jsx)("div", {
                                    className: "acc-switcher__separator"
                                }), (0, b.jsx)("div", {
                                ...
                                children: [(0, b.jsx)("span", {
                                    ...
                                    children: [(0, b.jsxs)("div", {
                                        ...
                                        children: [(0, b.jsx)(o.Text, {
                                            ...
                                            children: h ? (0, _.localize)("Demo") : (0, _.localize)("Real")
                                        }), p ? (0, b.jsx)(o.Icon, {
                                        ...
                                        children: (0, b.jsx)("p", {
                                            ...
                                            children: s ? `${c} ${(0,d.getCurrencyDisplayCode)(s)}` : (0, b.jsx)(_.Localize, {
                                                i18n_default_text: "No currency assigned"
                                            })
                                        })
                                    })]
