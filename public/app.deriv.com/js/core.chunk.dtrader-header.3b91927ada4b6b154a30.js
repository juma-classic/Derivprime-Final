    ...
    [3317], {
        289295: (e, t, s) => {
            ...
            const T = (0, l.observer)((() => {
                const {
                    ...
                    pathname: G
                } = (0, n.useLocation)(), W = G === c.routes.traders_hub || G.startsWith(c.routes.cashier) || G.startsWith(c.routes.account), [V, H] = i.useState(!1), [$, q] = i.useState(!1), [K, X] = i.useState([]), Y = i.useRef(), J = (0, n.useHistory)(), {
                    subscribe: Q,
                    rest: {
                        isSubscribed: Z
                    },
                ...
                i.useEffect((() => {
                    F && !Z && T && Q()
                }), [F, ee, Q, Z, T]), i.useEffect((() => () => {
                    Y.current && (clearTimeout(Y.current), q(!1), H(!1))
                }), [G]), i.useEffect((() => ((p || k) && (() => {
                    const e = (0, y.A)();
                    X(ne(e, [c.routes.account]))
                })(), () => clearTimeout(Y.current))), [p, k, h, W, a, U, B]);
                const te = i.useCallback((() => {
                        l && _(!1), V ? (q(!0), Y.current = setTimeout((() => {
                            H(!1), q(!1)
                        }), 400)) : H(!V)
                    }), [V, l, _]),
                    se = i.useCallback((async () => {
                        te(), window.location.pathname.startsWith(c.routes.phone_verification) && (d(!0), await new Promise((e => setTimeout(e, 0)))), J.push(c.routes.traders_hub), await E()
                    }), [J, E, te]),
                    ie = i.useCallback((() => {
                                ...
                                children: (0, N.jsx)(i.Fragment, {
                                    children: (0, N.jsxs)(m.MobileDrawer.Body, {
                                        ...
                                        children: [(0, N.jsx)("div", {
                                            ...
                                            if (!e.routes) return (0, N.jsx)(m.MobileDrawer.Item, {
                                            ...
                                            const s = e.routes.some((e => e.subroutes)),
                                                n = !a || !U,
                                                r = e => /passkeys/.test(e) ? n : !!/languages/.test(e) && h;
                                            return (0, N.jsxs)(i.Fragment, {
                                                children: [!s && e.routes.map(((e, t) => {
                                                    if (!e.is_invisible && (e.path !== c.routes.cashier_pa || L) && (e.path !== c.routes.cashier_pa_transfer || R) && (e.path !== c.routes.cashier_p2p || B) && (e.path !== c.routes.cashier_acc_transfer || z)) return (0, N.jsx)(m.MobileDrawer.Item, {
                                                        children: (0, N.jsx)(w.A, {
                                                            link_to: e.path,
                                                            icon: e.icon_component,
                                                            text: e.getTitle(),
                                                ...
                                                })), s && e.routes.map(((e, t) => e.subroutes ? (0, N.jsx)(m.MobileDrawer.SubMenuSection, {
                                                    section_icon: e.icon,
                                                    section_title: e.getTitle(),
                                                    children: e.subroutes.map(((e, t) => {
                                                        return (0, N.jsx)(w.A, {
                                                            is_disabled: (s = e.path, (/financial-assessment/.test(s) ? C : /trading-assessment/.test(s) ? C || "maltainvest" !== D : /proof-of-address/.test(s) || /proof-of-identity/.test(s) ? !k : /proof-of-income/.test(s) ? !O : !!/proof-of-ownership/.test(s) && (C || !I)) || e.is_disabled),
                                                            link_to: e.path,
                                                            text: e.getTitle(),
                                                            onClickLink: () => {
                                                                te(), e.path === c.routes.passkeys && ie()
                                                            },
                                                            is_hidden: r(e.path)
                                                        }, t);
                                                        var s
                                                    }))
                                                }, t) : (0, N.jsx)(m.MobileDrawer.Item, {
                                                    children: (0, N.jsx)(w.A, {
                                                        link_to: e.path,
                                                        icon: e.icon_component,
                                                        text: e.getTitle(),
                                        ...
                                        })(e, t))), S && (0, N.jsx)(m.MobileDrawer.Item, {
                                            onClick: se,
            ...
            const U = e => {
                let {
                    ...
                    if (Object.getOwnPropertySymbols) {
                        ...
                        for (i = 0; i < r.length; i++) s = r[i], -1 === t.indexOf(s) && {}.propertyIsEnumerable.call(e, s) && (n[s] = e[s])
                    }
                    return n
                }(e, O);
                return (0, N.jsx)(m.Icon, function(e) {
            ...
            const L = (0, l.observer)((e => {
                ...
                return (0, N.jsxs)(m.Modal, {
                    ...
                    children: [(0, N.jsxs)("div", {
                        ...
                        children: r.filter((e => !1 == !!e.is_disabled && (!e.is_virtual && "Non-EU" === g && e.loginid.startsWith("CR") || "EU" === g && e.loginid.startsWith("MF")))).map((e => {
                            let {
                                icon: t,
                                loginid: s
                            } = e;
                            ...
                            return (0, N.jsxs)("div", {
                                ...
                                onClick: async () => {
                                    s !== p && ((0, c.startPerformanceEventTimer)("switch_currency_accounts_time"), await l(s)), h()
                                },
                                children: [(0, N.jsx)(U, {
                                    ...
                                    children: x ? (0, N.jsx)(m.StatusBadge, {
                                        account_status: x,
                                        icon: j,
                                        text: A
                                    }) : (0, N.jsx)(m.Text, {
            ...
            const G = (0, l.observer)((e => {
                ...
                const {
                    ...
                    notifications: j,
                    toggleNotificationsModal: y
                } = r, w = j.filter((e => !e.only_toast_message));
                return (0, N.jsx)("div", {
            ...
            const V = (0, l.observer)((() => {
                const {
                    ...
                    client_notifications: q,
                    removeNotificationMessage: K
                } = r, {
                    setTogglePlatformType: X,
                    modal_data: Y
                } = l, {
                    isHubRedirectionEnabled: J,
                    isHubRedirectionLoaded: Q
                } = (0, a.A)(), {
                    isDesktop: Z
                } = (0, _.Y)(), ee = (0, n.useHistory)(), {
                    pathname: te
                } = (0, n.useLocation)(), se = [c.routes.traders_hub].includes(te) || [c.routes.account, c.routes.settings, c.routes.wallets_compare_accounts, c.routes.compare_cfds].some((e => te.startsWith(e))), ie = i.useCallback((() => K({
                    key: "new_version_available"
                })), [K]);
                i.useEffect((() => (document.addEventListener("IgnorePWAUpdate", ie), () => document.removeEventListener("IgnorePWAUpdate", ie))), [ie]);
                const ne = e => e.filter((e => e.link_to === c.routes.mt5 ? !A || y : e.link_to === c.routes.dxtrade ? x : e.href !== c.routes.bot && e.href !== c.routes.smarttrader || f)),
                    re = [c.routes.trade, c.routes.trader_positions, c.routes.complaints_policy, c.routes.endpoint, c.routes.redirect, c.routes.index, c.routes.error404, c.routes.reports, c.routes.positions, c.routes.profit, c.routes.statement, "/contract"].some((e => window.location.pathname.includes(e)));
                return !E && !re || b && !Q && !re || b && Q && !re && J ? null : (0, N.jsxs)("header", {
                    className: o()("header", {
                    ...
                    children: [(0, N.jsxs)("div", {
                        ...
                        children: [(0, N.jsxs)("div", {
                            ...
                            children: [Z ? (0, N.jsxs)(i.Fragment, {
                                children: [(0, N.jsx)(B.A, {}), (0, N.jsx)("div", {
                            ...
                            }), Z && !se && !location.pathname.includes(c.routes.cashier) && (0, N.jsx)(d.ft, {
                                app_routing_history: k,
                                platform_config: ne(C.A),
                                setTogglePlatformType: X,
                                current_language: O
                    ...
                    }), H && (0, N.jsx)(F.A, {}), (0, N.jsx)(R.A, {}), (0, N.jsx)(L, {
        ...
        471879: (e, t, s) => {
            ...
            const o = () => {
                ...
                const _ = null == c ? void 0 : c.authentication,
                    ...
                    p = null == _ || null === (t = _.identity) || void 0 === t || null === (t = t.services) || void 0 === t || null === (t = t.onfido) || void 0 === t ? void 0 : t.status,
                    h = null == _ || null === (s = _.identity) || void 0 === s || null === (s = s.services) || void 0 === s || null === (s = s.manual) || void 0 === s ? void 0 : s.status,
                    ...
                    N = d === b && m === b;
                return {
                    mf_account_status: m && p && h ? !w && (!y && !j) || x ? n.ACCOUNT_BADGE_STATUS.FAILED : w || v ? n.ACCOUNT_BADGE_STATUS.NEEDS_VERIFICATION : y || A ? n.ACCOUNT_BADGE_STATUS.PENDING : null : null,
                    kyc_status: N ? {} : {
                        poi_status: d,
                        poa_status: m,
                        valid_tin: 1,
        ...
        526248: (e, t, s) => {
            ...
            const l = () => {
                ...
                const {
                    ...
                    is_low_risk_cr_eu_real: g
                } = u, b = Boolean(null == t || null === (e = t.supported_currencies) || void 0 === e ? void 0 : e.includes(_.toLocaleLowerCase())) && !p && !g;
                return i.useEffect((() => {
                    if (m(b), d && h) {
                        const e = /deriv\.(com|me|be)/.test(window.location.hostname) ? o.deriv_urls.DERIV_HOST_NAME : window.location.hostname;
        ...
        263851: (e, t, s) => {
            ...
            const a = () => {
                ...
                return e && t && s && [i.ACCOUNT_BADGE_STATUS.PENDING, i.ACCOUNT_BADGE_STATUS.FAILED, i.ACCOUNT_BADGE_STATUS.NEEDS_VERIFICATION].includes(s) ? s : null
            }
        }
    }
]);
