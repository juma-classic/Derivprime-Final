    ...
    ["hooks_src_useMFAccountStatus_ts-src_AppV2_Components_Guide_Description_video-preview_tsx-src_-6b1461"], {
        "../hooks/src/useMFAccountStatus.ts": (e, t, r) => {
            ...
            function c() {
                ...
                function P(t, r) {
                    var n = r.method,
                        o = t.iterator[n];
                    if (o === e) return r.delegate = null, "throw" === n && t.iterator.return && (r.method = "return", r.arg = e, P(t, r), "throw" === r.method) || "return" !== n && (r.method = "throw", r.arg = new TypeError("The iterator does not provide a '" + n + "' method")), _;
                    var a = p(o, t.iterator, r.arg);
                    if ("throw" === a.type) return r.method = "throw", r.arg = a.arg, r.delegate = null, _;
                    var i = a.arg;
                    return i ? i.done ? (r[t.resultName] = i.value, r.next = t.nextLoc, "return" !== r.method && (r.method = "next", r.arg = e), r.delegate = null, _) : i : (r.method = "throw", r.arg = new TypeError("iterator result is not an object"), r.delegate = null, _)
                }
                ...
                return E.prototype = b, o(w, "constructor", {
                    value: b,
                    configurable: !0
                }), o(b, "constructor", {
                    value: E,
                    configurable: !0
                }), E.displayName = f(b, s, "GeneratorFunction"), t.isGeneratorFunction = function(e) {
                    var t = "function" == typeof e && e.constructor;
                    return !!t && (t === E || "GeneratorFunction" === (t.displayName || t.name))
                }, t.mark = function(e) {
                    return Object.setPrototypeOf ? Object.setPrototypeOf(e, b) : (e.__proto__ = b, f(e, s, "GeneratorFunction")), e.prototype = Object.create(w), e
                }, t.awrap = function(e) {
                    return {
                        __await: e
                    }
                }, L(O.prototype), f(O.prototype, u, (function() {
                    return this
                ...
                }, L(w), f(w, s, "Generator"), f(w, l, (function() {
                    return this
            ...
            const u = function() {
                var e = (0, o.A)().client.is_eu,
                    ...
                    r = function() {
                        var e, t, r, i, u, s, f, d, p = (0, o.A)().client || {},
                            h = p.account_status,
                            m = p.is_logged_in,
                                ...
                                return t = c().mark((function e() {
                                    return c().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            case 0:
                                                if (!m || h && window.location.pathname.startsWith(n.routes.trade)) {
                                                    e.next = 3;
                                                    break
                                                }
                                                return e.next = 3, v();
                        ...
                        var y = null == h ? void 0 : h.authentication,
                            ...
                            g = null == y || null === (t = y.identity) || void 0 === t || null === (r = t.services) || void 0 === r || null === (i = r.onfido) || void 0 === i ? void 0 : i.status,
                            E = null == y || null === (u = y.identity) || void 0 === u || null === (s = u.services) || void 0 === s || null === (f = s.manual) || void 0 === f ? void 0 : f.status,
                            ...
                            R = _ === T && b === T;
                        return {
                            mf_account_status: b && g && E ? !I && !P && !x || w ? n.ACCOUNT_BADGE_STATUS.FAILED : I || O ? n.ACCOUNT_BADGE_STATUS.NEEDS_VERIFICATION : P || L ? n.ACCOUNT_BADGE_STATUS.PENDING : null : null,
                            kyc_status: R ? {} : {
                                poi_status: _,
                                poa_status: b,
                                valid_tin: 1,
                ...
                return e && t && r && [n.ACCOUNT_BADGE_STATUS.PENDING, n.ACCOUNT_BADGE_STATUS.FAILED, n.ACCOUNT_BADGE_STATUS.NEEDS_VERIFICATION].includes(r) ? r : null
            }
        },
            ...
            const v = function(e) {
                var t = e.contract_type,
                    ...
                    g = o().useCallback((function(e) {
                        return (0, f.getUrlBase)("/public/videos/".concat(t.toLowerCase(), "_").concat(n || _ ? "mobile" : "desktop", ".").concat(e))
                    }), [t, _]),
                ...
                return o().useEffect((function() {
                    ...
                    return v && v.addEventListener("load", e),
                        function() {
                            v && v.removeEventListener("load", e)
                        }
                }), [v]), o().createElement("div", {
                    className: l()("video-fragment__wrapper", {
                        "video-fragment__wrapper--accumulator": t.toLowerCase() === d.OA.ACCUMULATORS.toLowerCase()
                    })
                }, i && o().createElement(u.Skeleton, {
                    width: 248,
                    height: 161,
            ...
            var E = function() {
                ...
                b = function(e) {
                    var t = e.contract_type,
                        r = e.term;
                    if (t && r) {
                        var n, i, c, l, u, s, f, p, h, m, v, y, _, b, A, T, S, w, L, O, x, P, I, R = (i = E(), c = i.BARRIER, l = i.CONTRACT_VALUE, u = i.DEAL_CANCELLATION, s = i.ENTRY_SPOT, f = i.EXIT_SPOT, p = i.EXPIRY, h = i.FINAL_PRICE, m = i.GROWTH_RATE, v = i.PAYOUT, y = i.PAYOUT_PER_POINT, _ = i.PREVIOUS_SPOT_PRICE, b = i.RANGE, A = i.SLIPPAGE_RISK, T = i.STOP_OUT, S = i.STOP_LOSS, w = i.STRIKE_PRICE, L = i.TAKE_PROFIT, O = i.INDEX, x = i.STAKE, P = i.BARRIER_RANGE, I = i.SPOT_PRICE, g(g(g(g(g(g(g(g(g(g(n = {}, c, o().createElement(a.Localize, {
                            i18n_default_text: "The corresponding price level based on the payout per point you’ve selected."
                        })), I, o().createElement(a.Localize, {
                            i18n_default_text: "The real-time price of an asset for immediate buying and selling."
                        })), l, (function(e) {
                            return e === d.OA.VANILLAS ? o().createElement(a.Localize, {
                                i18n_default_text: "The current value of a trade contract, based on the initial buy price and the current profit/loss."
                            }) : o().createElement(a.Localize, {
                                i18n_default_text: "This is the resale value of your contract, based on the prevailing market conditions (e.g, the current spot), including additional commissions if any."
                            })
                        })), u, o().createElement(a.Localize, {
                            i18n_default_text: "A feature that lets you cancel your trade and get your stake back if the price moves against you."
                        })), s, o().createElement(a.Localize, {
                            i18n_default_text: "The specific price level at which a trader decides to buy or sell an asset."
                        })), f, o().createElement(a.Localize, {
                            i18n_default_text: "The specific price level at which a trader closes their positions in a market, either to realise profits or limit losses."
                        })), p, o().createElement(a.Localize, {
                            i18n_default_text: "The moment when a contract ends — the exact time at which it matures. It marks the final point when the outcome of the contract is determined."
                        })), h, o().createElement(a.Localize, {
                            i18n_default_text: "This is the spot price of the last tick at expiry."
                        })), m, o().createElement(a.Localize, {
                            i18n_default_text: "A feature that lets you select a percentage gain for your stake (1%, 2%, 3%, 4%, or 5%)."
                        })), v, o().createElement(a.Localize, {
                            i18n_default_text: "The sum of your initial stake and profit."
                        })), g(g(g(g(g(g(g(g(g(g(n, y, o().createElement(a.Localize, {
                            i18n_default_text: "The money you make or lose for every one-point change in an asset’s price."
                        })), _, o().createElement(a.Localize, {
                            i18n_default_text: "The price from the trading period that just ended."
                        })), b, o().createElement(a.Localize, {
                            i18n_default_text: "It is a percentage of the previous spot price. The percentage rate is based on your choice of the index and the growth rate."
                        })), A, o().createElement(a.Localize, {
                            i18n_default_text: "The chance that your order will be executed at a worse price than you expected."
                        })), T, o().createElement(a.Localize, {
                            i18n_default_text: "An automated action to close a trader’s open positions when their account’s equity falls to a predetermined level."
                        })), S, o().createElement(a.Localize, {
                            i18n_default_text: "An order placed to automatically sell an asset once it reaches a certain price."
                        })), w, o().createElement(a.Localize, {
                            i18n_default_text: "The agreed-upon price in the contract that decides whether your trade wins or loses."
                        })), L, o().createElement(a.Localize, {
                            i18n_default_text: "An order set by a trader to automatically close a profitable position when an asset’s price reaches a specified level."
                        })), O, o().createElement(a.Localize, {
                            i18n_default_text: "A measure of a section of shares in the stock market."
                        })), x, o().createElement(a.Localize, {
                            i18n_default_text: "The amount of money risked in your trade."
                        })), g(n, P, o().createElement(a.Localize, {
                            i18n_default_text: "The maximum amount the price is allowed to move from its previous value at each step. If the price goes beyond that amount, the contract ends."
                        })))[r];
                ...
                T = function(e) {
                    ...
                    return e.map((function(e, r) {
                        var n = e.type,
                            a = e.text;
                        return "heading" === n && "string" != typeof a ? o().createElement(i.E, {
                            key: a.props.i18n_default_text,
                            bold: !0,
                            size: "md",
                            className: "description__heading"
                        }, a) : "paragraph" !== n && "general" !== n || "string" == typeof a ? "video" === n && "string" == typeof a ? o().createElement(v, {
                            contract_type: a,
                            key: a + r,
                            is_mobile_forced: t
                        }) : "badge" === n && "string" != typeof a ? o().createElement(A, {
                            key: "badge-".concat(r)
                        }, a) : void 0 : o().createElement(i.E, {
                            as: "p",
                            key: a.props.i18n_default_text,
                            size: "sm",
                ...
                S = g(g(g(g(g(g(g(g(g(g({}, d.OA.ACCUMULATORS, y.fm.accumulator), d.OA.EVEN_ODD, y.fm.even_odd), d.OA.HIGHER_LOWER, y.fm.high_low), d.OA.MATCHES_DIFFERS, y.fm.match_diff), d.OA.MULTIPLIERS, y.fm.multiplier), d.OA.OVER_UNDER, y.fm.over_under), d.OA.RISE_FALL, y.fm.rise_fall), d.OA.TOUCH_NO_TOUCH, y.fm.touch), d.OA.VANILLAS, y.fm.vanilla), d.OA.TURBOS, y.fm.turbos),
                w = function() {
                    var e, t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                    return null === (e = S[arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : ""]) || void 0 === e ? void 0 : e[t ? "dark" : "light"]
                }
        },
        "./src/Modules/Trading/Helpers/video-config.ts": (e, t, r) => {
            ...
            var n = {
                ...
                a = function() {
                    var e, t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                    return null === (e = n[arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : ""]) || void 0 === e ? void 0 : e[t ? "dark" : "light"]
                }
        },
        "./src/Stores/Modules/Trading/Helpers/allow-equals.ts": (e, t, r) => {
            ...
            var u = function(e) {
                    var t, r;
                    return !(0, n.isEmptyObject)(e) && !(null === (t = (0, n.getPropertyValue)(e, "Ups & Downs")) || void 0 === t || null === (r = t.categories) || void 0 === r || !r.some((function(e) {
                ...
                s = function(e, t, r) {
                    ...
                    var a = Object.keys(e || {}).reduce((function(t, r) {
                        var n = e[r];
                        return [].concat(c(t), c(n.categories.map((function(e) {
                            return e.value
                        }))))
                    }), []).map((function(e) {
                        return i({}, e, (0, n.getPropertyValue)(o.h.getFullContractTypes(), [e, "config", "durations", "units_display", r]))
                    }));
                    if (u(e)) {
                        var l = a.filter((function(e) {
                            return null == e ? void 0 : e.rise_fall_equal
                        }));
                        if (l.length > 0) return l[0].rise_fall_equal.some((function(e) {
                            return e.value === t
                        }))
                    }
                    return !1
