...
(self.webpackChunk_deriv_trader = self.webpackChunk_deriv_trader || []).push([
    ["settings-chart"], {
        "./src/App/Containers/SettingsModal/settings-chart.tsx": (e, t, l) => {
            l.r(t), l.d(t, {
                default: () => _
            });
            var n = l("react"),
                r = l.n(n),
                a = l("@deriv/components"),
                c = l("@deriv/translations"),
                i = function(e) {
                    var t = e.children;
            ...
            var m = l("mobx-react-lite"),
                f = l("../stores/src/useStore.ts"),
                u = ["styles"];
            ...
            const d = function(e) {
                ...
                var t = function(e, t) {
                    ...
                    if (Object.getOwnPropertySymbols) {
                        ...
                        for (n = 0; n < a.length; n++) l = a[n], -1 === t.indexOf(l) && {}.propertyIsEnumerable.call(e, l) && (r[l] = e[l])
                    }
                    return r
                }(e, u);
                return r().createElement("svg", h({
                ...
                }, t), r().createElement("title", null, "Group"), r().createElement("defs", null, r().createElement("linearGradient", {
                    x1: "50%",
                    y1: "147.77%",
                    x2: "50%",
                    y2: "10.76%",
                    ...
                    fillOpacity: ".8",
                    fill: "url(#a)",
                    d: "M96 34.45l-9.5-.06-5 26.27-2-19.7-25-6.57-2-18.39-23 18.39-4 19.7-3-38.09-9 57.79H0v45.31l96 .9z"
                }), r().createElement("path", {
                    d: "M96 34.08c-.03.33-.24.59-.5.59h-8.57L82 60.34c-.1.74-.92.73-1-.02l-1.98-19.49-24.9-6.4a.77.77 0 01-.11-.33l-1.9-17.37-22.18 17.7-3.95 19.42c-.14.7-.92.62-.98-.1l-2.66-33.78-8.35 53.5c-.05.31-.25.53-.49.53H0v-1.31h13.1L22 15.52c.12-.73.93-.68.99.07l2.72 34.47 3.3-16.22c.03-.16.11-.3.22-.39l23-18.35c.3-.25.7 0 .76.46l1.98 18.18 24.91 6.42c.06.1.1.2.1.32l1.57 15.33L86 33.91c.04-.32.25-.55.5-.55 5.25-.04 8.1-.04 8.54 0 .44.03.76.27.95.72z",
                    fill: "#FFF",
                    fillRule: "nonzero"
                }), r().createElement("path", {
                    d: "M115.28 33.67l6.44-7.67H160v16h-38.28l-6.44-7.67H113v-.66h2.28zm-16.42 0h.8v.66H99v.07a2 2 0 11-.14-.73zm3.47.66v-.66H105v.66h-2.67zm5.34 0v-.66h2.66v.66h-2.66z",
                    fill: "#FF444F"
                })))
            };
            var p = ["styles"];
            ...
            const F = function(e) {
                ...
                _ = (0, m.observer)((function() {
                    var e = (0, f.A)(),
                        t = e.contract_trade,
                        l = e.ui,
                        n = l.is_chart_countdown_visible,
                        m = l.is_dark_mode_on,
                        u = l.setChartCountdown,
                        h = t.granularity;
                    return r().createElement("div", {
                        className: "settings-chart"
                    }, r().createElement(v, null, r().createElement(o, null, r().createElement(c.Localize, {
                        i18n_default_text: "Interval duration"
                    }), 0 === h && r().createElement(a.InlineMessage, {
                        type: "information",
                        message: r().createElement(c.Localize, {
                            i18n_default_text: "This feature is unavailable for tick intervals. Switch to minutes, hours, or days."
                        })
                    })), r().createElement(i, null, r().createElement(s, {
                        disabled: m ? d : O,
                        enabled: m ? E : F,
                        ...
                        defaultChecked: n,
                        disabled: 0 === h,
                        label: r().createElement(c.Localize, {
                            i18n_default_text: "Display remaining time for each interval"
                        }),
                        onChange: function(e) {
                            "checked" in e.target && u(e.target.checked)
                        }
                    })))))
                }))
        }
